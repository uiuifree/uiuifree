  ...
  **Web Backend Developer / Engineer** based in Japan 🇯🇵
  ...
  Rustが好きです。バックエンド開発を中心に、様々なAPIクライアントライブラリや地理空間データライブラリを公開しています。
  ...
  Google APIsや各種サービスのRustクライアント、地理空間データライブラリを開発しています。
  ...
  ### 🗺 Geospatial
  | Repository | Description | crates.io |
  |------------|-------------|-----------|
  | [rust-jismeshcode](https://github.com/uiuifree/rust-jismeshcode) | 日本標準地域メッシュコード（JIS X 0410）のRustライブラリ |  [![Crates.io](https://img.shields.io/crates/v/jismeshcode.svg)](https://crates.io/crates/jismeshcode) |
